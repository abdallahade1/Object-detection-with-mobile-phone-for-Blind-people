...
public class AppMan : MonoBehaviour
{
    ...
    public GameObject text2SpeechPanel;
    ...
    // UI Helpers 
    public void OpenBraillePanelBtnCallback()
    {
        HideAllPanels();
        ShowPanel(braillePanel);
    }
    public void CloseBraillePanelBtnCallback()
    {
        HidePanel(braillePanel);
        ShowPanel(mainMenuPanel);
    }
    public void OpenText2SpeechPanelBtnCallback()
    {
        HideAllPanels();
        ShowPanel(text2SpeechPanel);
    }
    public void CloseText2SpeechPanelBtnCallback()
    {
        HidePanel(text2SpeechPanel);
        ShowPanel(mainMenuPanel);
    }
    public void OpenObjectDetectionPanelBtnCallback()
    {
        HideAllPanels();
        ShowPanel(objectDetectionPanel);
    }
    public void CloseObjectDetectionPanelBtnCallback()
    {
        HidePanel(objectDetectionPanel);
        ShowPanel(mainMenuPanel);
    }
    public void OpenGPSPanelBtnCallback()
    {
        HideAllPanels();
        ShowPanel(gpsPanel);
    }
    public void CloseGPSPanelBtnCallback()
    {
        HidePanel(gpsPanel);
        ShowPanel(mainMenuPanel);
    }
